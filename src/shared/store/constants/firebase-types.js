export const Types = {
  ...
  USER_CREATE_START: 'firebase/user/create/start',
  USER_CREATE_SUCCESS: 'firebase/user/create/success',
  USER_CREATE_FAIL: 'firebase/user/create/fail',
  USER_SESSION_LOAD: 'firebase/user/session/load',
}